...
local priest_leap_of_faith = project.gui.priest_discipline_group:Tab("Leap of Faith")
...
priest_leap_of_faith:Checkbox({
    text = leap_of_faith_txt .. "Leap of Faith - Melees",
    var = "priest_leap_of_faith_melees",
    default = true,
})
...
priest_leap_of_faith:Checkbox({
    text = capacitor_totem_txt .. "Ground Effects",
