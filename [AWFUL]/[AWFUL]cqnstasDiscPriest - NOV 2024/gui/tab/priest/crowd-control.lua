...
local priest_cc = project.gui.priest_group:Tab("Crowd Control")
...
priest_cc:Checkbox({
    text = psychicScreamTxt .. "No Dispel",
    var = "priest_cc_psychic_scream_dispel",
    default = true,
    tooltip = "Uses Psychic Scream on an enemy that is not attacked and healer cannot dispel.",
})
